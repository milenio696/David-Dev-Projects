...
public class Resumen extends javax.swing.JFrame {
    ...
    private final Gasto gasto = new Gasto();
    private final LogicaGasto logic = new LogicaGasto();
    private DefaultTableModel Model = new DefaultTableModel();
    private final String[] titulos = {"Año","Mes", "Fecha", "Categoria", "Monto", "Descripcion"};
    ...
    public Resumen() {
        ...
        logic.DateOrder(gasto);
        logic.DateMonth(gasto);

        Model.setRowCount(0);

        for (Object[] text : gasto.getListaGastos()) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Presentacion/Imagenes/Technology-Watch.jpg"))); // NOI18N
